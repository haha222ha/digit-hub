 ...
 * 用于保存和恢复答题进度、测试结果等数据
 * 
 * 注意：使用测试特定前缀 sri_test_，避免与其他测试冲突
 */

const STORAGE_PREFIX = 'sri_test_';

/**
 * 保存答题进度到本地存储
 * @param {Array} answers - 答案数组（50题）
 * @param {number} currentQuestion - 当前题目索引（0-49）
 ...
 * @param {number} totalQuestions - 总题目数（默认50）
 * @returns {Object} 统计信息
 */
export const getProgressStats = (answers, totalQuestions = 50) => {
